...
<head>
    ...
    <title>Maintenance & Réseaux - Agence de marketing digital</title>
    ...
    <main>
        ...
        <section class=" lg:mt-12 mt-20 justify-start">
            ...
            <div
                ...
                <img class="w-full" src="images/bannière- maintance et réseau.jpg"
                    alt="bannière-médias-sociaux-numev" />
                ...
                <div class="flex ">
                    <div class="w-[25%] hidden lg:block ">
                        ...
                        <img src="images/c2c898ac-ccd0-4880-9ac3-381e93c03de6.png"
                            alt="marketing-digital-service-création-de-site-web" class="lg:w-2/3 mt-4">
                    </div>

                    <div class="lg:w-[75%] mb-4 justify-center  mx-4 lg:mx-0">
                        <h2 class="ek vj text-xl lg:text-4xl kk wm nb gb ml-9 lg:ml-0">Maintenance & Réseaux</h2>
                        <div class="relative">
                            <img src="images/maintenace.jpg" alt="img-gestion-des-médias-sociaux-1"
                                class="lg:float-left lg:w-[40%] h-96 lg:mr-4 ">
                            <p class="text-sm lg:text-lg text-justify text-gray-600 ">
                                La maintenance et les réseaux sont des piliers essentiels dans le bon fonctionnement des
                                systèmes informatiques et des infrastructures technologiques. La maintenance vise à
                                assurer la stabilité, la fiabilité et la performance des équipements, tandis que les
                                réseaux permettent la communication et le partage d'informations entre les différents
                        ...
                        <p class="text-sm lg:text-lg text-justify text-gray-600 ">
                            ...
                            Nos services de maintenance et réseaux sont conçus pour répondre aux besoins spécifiques de
                            votre entreprise. Que ce soit pour la gestion proactive des équipements, la résolution
                            rapide des problèmes, ou l'optimisation des réseaux, notre équipe d'experts est là pour
                            garantir la continuité de vos opérations.En investissant dans nos solutions de maintenance et de gestion des réseaux, vous pouvez vous concentrer sur votre cœur de métier, en toute confiance, sachant que vos systèmes sont entre de bonnes mains. Nous vous accompagnons dans l'évolution constante de la technologie, assurant ainsi la pérennité et la performance de vos infrastructures informatiques. Faites le choix de la tranquillité d'esprit avec nos services de maintenance et réseaux.
                        </p>
                        <a href="/contact"
                            class="ek jk lk gh gi hi rg   bg-orange-500 hover:bg-blue-700 ml-6 lg:ml-0 float-left mt-12 lg:w-1/3 text-center">
                            Je confie mes installations</a>
                    </div>
