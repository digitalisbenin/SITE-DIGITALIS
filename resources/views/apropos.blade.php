...
<head>
    ...
    <title>A propos de nous - Agence de marketing digital </title>
    ...
    <main>
        ...
        <section class="lg:mt-12 mt-20 justify-start">
            ...
            <div
                ...
                <img class="w-full" src="images/bannière-a-propos-marketing-digital-numev.jpg"
                    alt="bannière-a-propos-marketing-digital-numev" />



                <div class="flex ">

                    <div class=" mb-4 justify-center  mx-4 lg:mx-32">
                        <h2 class="ek vj lg:text-3xl text-xl kk wm nb gb ml-16 lg:ml-0 ">En savoir plus sur nous</h2>
                        <p class="text-sm lg:text-lg text-justify text-gray-600">Implantée dans la commune d’Abomey-calavi, la
                            société ‘‘ DIGITALIS ’’ pour vocation d‘œuvrer au développement d’un grand nombre
                            d’entreprises et d’acteurs à travers un accompagnement dans les domaines de la
                            digitalisation, du renforcement de capacités, de la prospective, et de la gestion de
                            projets, etc.

                        </p>
                        <p class="text-sm lg:text-lg text-justify text-gray-600">A travers sa gamme variée de services, DIGITALIS
                            assiste sa clientèle dans la mise en place des outils utiles et adaptés pour la gestion
                            performante de leur organisation. DIGITALIS se veut d’être votre partenaire pour
                            l’optimisation de vos ressources, la performance et le développement de votre structure.

                        </p>
                        <div class="lg:flex mt-9 ">
                            <img src="images/why-us.png" alt="img-a-propos-marketing-digital"
                                class="lg:w-[50%] ">

                            <ul class="tc uf cg 2xl:ud-gap-15 fb text-sm lg:text-lg text-gray-600">
                                <li><span class=" rc kk wm text-2xl mt-20">Notre expertise </span> Accroitre la visibilité des
                                    entreprises sur
                                    internet.</li>
                                <li><span class="rc kk wm text-2xl text-gray-600">Notre efficacité </span> Apportez des solutions numériques
                                    aux entreprises où qu’elles soient dans le monde.</li>
                                <li><span class="rc kk wm text-2xl mb-16 text-gray-600"> Notre rapidité <br /><span
                                            class="text-sm lg:text-lg "> Passion, innovation, recherche de
                                            l’excellence.</span></li>
                            </ul>
