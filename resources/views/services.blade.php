...
<head>
    ...
    <title>Nos services - Agence de marketing digital </title>
    ...
    <main>
        ...
        <section class=" lg:mt-12 mt-20 justify-start">
            ...
            <div
                ...
                <img class="w-full" src="images/bannière-service-marketing-digital-numev.jpg"
                    alt="bannière-service-marketing-digital-numev" />
                ...
                <div class="flex ">
                    <div class="w-[25%] hidden lg:block ">
                        ...
                        <img src="images/44a4becf-3831-4050-aba4-126f23ebfcbe.png"
                        alt="marketing-digital-service-création-de-site-web" class="lg:w-2/3 mt-4">
                        
                    </div>

                    <div class="lg:w-[75%] mb-4 justify-center mx-4 lg:ml-0  mt-12">
                        <p class="text-sm lg:text-lg text-justify text-gray-600">Accroître vos ventes est l'objectif
                            essentiel de toute entreprise. À l'ère numérique, une présence en ligne solide est cruciale.
                            Sans elle, vous risquez de perdre une part importante du marché au profit de vos
                            concurrents. Passer à l'ère numérique est impératif pour stimuler votre chiffre d'affaires.
                            Pour chaque défi numérique, DIGITALIS offre des solutions adaptées et maîtrisées</p>
                        <div class="  h-0.5 mt-2 bg-line mb-9 border border-line"></div>
                        ...
                        <div class="lg:flex  ">
                            <div class="">
                                <h2 class="ek vj text-xl lg:text-4xl kk ml-16 lg:ml-0  ">Ingénierie Informatique</h2>
                                <p class=" text-sm text-justify lg:text-lg  mr-2 text-gray-600 ">
                                    Le site web demeure aujourd'hui le moyen le plus performant en termes de résultats.
                                    Il offre la possibilité de résoudre de nombreux problèmes sans intervention humaine,
                                    fonctionnant 24h/24 et accessible partout dans le monde.
                                    <a class="ql vb du-ease-in-out il xl text-blue-500 mt-9"
                                        href="/creation-site-web"><strong>En savoir
                                            plus</strong></a>
                                </p>
                            </div>


                            <img src="images/bannière-site-web-numev.jpg"
                                alt="marketing-digital-service-création-de-site-web" class="lg:w-1/2 ">
                        ...
                        <div class="lg:flex  ">
                            <div>
                                <h2 class="ek vj text-xl lg:text-4xl kk mb-2 ml-9 lg:ml-0">Maintenance & Réseaux</h2>
                                <p class="text-sm lg:text-lg  text-justify mr-2 text-gray-600">
                                    Les médias sociaux vous permettent de disposer d’une communauté à l’écoute des
                                    actualités de votre entreprise. Puisque constituée de consommateurs, votre
                                    communauté
                                    peut constituer d’une potentielle clientèle pour votre entreprise.
                                    <a class="ql vb du-ease-in-out il xl text-blue-500"
                                        href="/gestion-medias-sociaux"><strong>En savoir
                                            plus</strong></a>
                                </p>
                            </div>
                            <img src="images/bannièremaintenanceinformatique.jpg"
                                alt="marketing-digital-service-gestion-des-médias-sociaux" class="lg:w-1/2  ">
                        ...
                        <div class="lg:flex  ">
                            <div>
                                <h2 class="ek vj text-xl lg:text-4xl kk mb-2 ml-16 lg:ml-0">Conception graphique</h2>
                                <p class=" text-sm lg:text-lg  text-justify mr-2 text-gray-600">
                                    La conception graphique est l'art de donner vie à votre identité visuelle. C'est
                                    bien plus qu'une simple question d'esthétique ; c'est un moyen puissant de
                                    communiquer, d'attirer l'attention et de transmettre votre message de manière
                                    visuellement impactante.
                                    <a class="ql vb du-ease-in-out il xl text-blue-500"
                                        href="/conception-graphique"><strong>En savoir
                                            plus</strong></a>
                                </p>
                            </div>
                            <img src="images/bannière-graphiqu.jpg"
                                alt="marketing-digital-service-conception-graphique" class="lg:w-1/2  ">
                        ...
                        <div class="lg:flex ">
                            <div>
                                <h2 class="ek vj text-xl lg:text-4xl kk mb-2 text-justify ml-20 lg:ml-0">Communication
                                    et Marketing digital</h2>
                                <p class="text-sm lg:text-lg  text-justify mr-2 text-gray-600">
                                    A l’instar des contenus graphiques, les vidéos représentent des outils marketing
                                    puissants pour présenter votre entreprise, mettre en avant un concept, et surtout,
                                    favoriser la vente d'un produit. Consultez notre page dédiée au service de
                                    production pour en savoir plus
                                    <a class="ql vb du-ease-in-out il xl text-blue-500"
                                        href="/production-vidéo"><strong>En savoir
                                            plus</strong></a>
                                </p>
                            </div>
                            <img src="images/bannière-MARKeting.jpg" alt="marketing-digital-service-production-vidéo"
                                class="lg:w-1/2  ">
                        ...
                        <div class="lg:flex ">
                            <div>
                                <h2 class="ek vj text-xl lg:text-4xl kk mb-2 text-justify ml-20 lg:ml-0">Formations &
                                    divers</h2>
                                <p class="text-sm lg:text-lg  text-justify mr-2 text-gray-600">
                                    Nos formations sont conçues pour vous offrir une expérience d'apprentissage
                                    enrichissante et adaptée à vos besoins. Que vous souhaitiez acquérir de nouvelles
                                    compétences, approfondir vos connaissances ou vous spécialiser dans un domaine
                                    spécifique, nos programmes de formation sont conçus par des experts du secteur.
                                    <a class="ql vb du-ease-in-out il xl text-blue-500"
                                        href="/redaction-web"><strong>En savoir
                                            plus</strong></a>
                                </p>
                            </div>

                            <img src="images/bannière-divers.jpg" alt="marketing-digital-service-rédaction-web"
                                class="lg:w-1/2  ">
                        ...
                        <div class="  h-0.5 mt-6 bg-line mb-9 border border-line"></div>
                        <a href="/contact"
                            class="ek jk lk gh gi hi rg  il  bg-orange-500 float-left hover:bg-blue-700 ml-16 lg:ml-0  mt-12 lg:w-1/3 text-center">
