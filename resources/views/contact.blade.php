...
<head>
    ...
    <title>Contactez-nous - Agence de marketing digital </title>
    ...
    <main>
        ...
        <section class="lg:mt-12 mt-20 justify-start">
            <div class="animate_top   rounded-md shadow-solid-13 bg-white dark:bg-blacksection dark:border-strokedark p-7.5 md:p-10">
                <img class="w-full mb-9 " src="images/bannière-contact-marketing-digital-numev.jpg" alt="bannière-contact-marketing-digital-numev" />
                <div class="tc wf gg qq">
                    <!-- About Images -->
                    <div class="animate_left  jn/2 ">

                        <h2 class="fk vj zp pr text-3xl kk wm qb ml-6 lg:ml-0">Contactez-nous</h2>
                        ...
                        <div class="animate_top w-full nn/5 vo/3 vk sg hh sm yh tq">
                                ...
                                <div class="tc sf yo ap zf ep qb">
                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900" for="fullname">Nom et prénom<span class="text-red-500">*</span></label>
                                    ...
                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900" for="email">Adresse e-mail<span class="text-red-500">*</span></label>
                                ...
                                <div class="tc sf yo ap zf ep qb">
                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900" for="phone">Numéro de téléphone<span class="text-red-500">*</span></label>
                                        <input type="number" name="phone" id="phone" required
                                            placeholder="+229 99255454"
                                            class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                                    </div>

                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900 " for="subject">Pays<span class="text-red-500">*</span></label>
                                        <input type="text"  id="subject" name="pays"  required
                                            placeholder="Bénin"
                                            class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                                    </div>
                                </div>
                                <div class="tc sf yo ap zf ep qb">
                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900" for="phone">Nom de votre entreprise</label>
                                        <input type="text" name="entrepise" id="phone"
                                            placeholder="Numev"
                                            class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                                    </div>

                                    <div class="vd to/2">
                                        <label class="rc ac text-sm lg:text-lg text-gray-900 " for="subject">Site web</label>
                                        <input type="text" for="subject" id="subject"
                                            placeholder="https://digitalis-benin.com/"
                                            class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                                    </div>
                                </div>

                                <div class="fb">
                                    <label class="rc ac text-sm lg:text-lg text-gray-900" for="message">Message<span class="text-red-500">*</span></label>
                                    <textarea placeholder="Message" rows="4" name="message" id="message" required
                                    ...
                                    <div class="mt-4 space-y-4">
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="services" name="services[]" type="checkbox" value="Création de site web"
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                                <label for="comments" class="font-medium text-gray-700">Ingénierie Informatique</label>

                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="services" name="services[]" type="checkbox" value="Gestion des
                                                médias sociaux"
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                                <label for="candidates" class="font-medium text-gray-700">Maintenance & Réseaux</label>
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 text-sm">
                                                <label for="offers" class="font-medium text-gray-700">Conception graphique</label>

                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="services" name="services[]" type="checkbox" value="Production
                                                vidéo"
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                                <label for="offers" class="font-medium text-gray-700">Communication et Marketing numérique</label>

                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                            <div class="flex h-5 items-center">
                                                <input id="services" name="services[]" type="checkbox" value="Rédaction
                                                web"
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            </div>
                                            <div class="ml-3 text-sm">
                                                <label for="offers" class="font-medium text-gray-700">Formations & plongeurs</label>
                                ...
                                <div class="tc xf mt-4">
                                    <button class="vc rg lk gh ml il hi gi _l bg-orange-500 hover:bg-blue-700 ">Envoyer</button>
                                </div>
                    ...
                    <!-- About Content -->
                    <div class="animate_right jn/2 hidden lg:block  mb-96">

                        <img src="images/skills.png" alt="img-contact-marketing-digital"  />
