...
<head>
    ...
    <title>Conception graphique - Agence de marketing digital </title>
    ...
    <main>
        ...
        <section class="lg:mt-12 mt-20 justify-start">
            ...
            <div
                ...
                <img class="w-full " src="images/bannière-conception-graphique-numev.jpg"
                    alt="bannière-conception-graphique-numev" />
                <div class="flex ">
                    <div class="w-[25%] hidden lg:block ">
                        ...
                        <img src="images/c25f6e6f-de55-4898-b485-71112ed91b06.png"
                            alt="marketing-digital-service-création-de-site-web" class="lg:w-2/3 mt-4">
                    </div>
                    <div class="lg:w-[75%] mb-4  lg:ml-0 justify-center  mx-4 lg:mx-0">


                        <h2 class="ek vj text-xl lg:text-4xl kk wm nb gb ml-14 lg:ml-0">Conception graphique</h2>
                        <div class="relative">
                            <img src="images/conception.jpg" alt="marketing-digital-img-conception-graphique"
                                class="lg:float-left lg:mr-2 lg:w-[35%] ">
                            <p class="text-sm lg:text-lg text-justify lg:ml-96 text-gray-600">
                                La conception graphique est l'art de donner vie à votre identité visuelle. C'est bien
                                plus qu'une simple question d'esthétique ; c'est un moyen puissant de communiquer,
                                d'attirer l'attention et de transmettre votre message de manière visuellement
                                impactante.

                                Notre équipe de conception graphique excelle dans la création d'éléments visuels qui
                                reflètent l'essence même de votre entreprise. Que ce soit pour la conception de logos,
                                d'images de marque, de supports publicitaires ou de contenu pour les médias sociaux,
                                nous mettons notre créativité au service de votre image de marque.
                            </p>
                        </div>

                        <p class="text-sm lg:text-lg  mt-4 text-justify text-gray-600"> Chaque création graphique est
                            pensée de manière stratégique, en tenant compte de votre public cible et de vos objectifs
                            commerciaux. Nous croyons en la puissance de l'esthétique bien pensée pour captiver
                            l'audience, renforcer la reconnaissance de la marque et susciter l'engagement.

                            Explorez notre service de conception graphique pour donner vie à vos idées, renforcer votre
                            présence visuelle et laisser une impression mémorable sur votre audience. Faites de chaque
                            visuel une œuvre d'art qui raconte votre histoire et captive votre public..</p>

                        <a href="/contact"
                            class="ek jk lk gh gi hi rg   bg-orange-500 hover:bg-blue-700 ml-2 lg:ml-0 float-left mt-12 lg:w-1/3 text-center">
                            Je veux une conception graphique</a>
                    </div>
