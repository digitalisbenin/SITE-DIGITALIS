...
<head>
    ...
    <title>Formations & divers - Agence de marketing digital </title>
    ...
    <main>
        ...
        <section class="lg:mt-12 mt-20 justify-start">
            ...
            <div
                ...
                <img class="w-full" src="images/bannière-communication -formation.jpg"
                    alt="bannière-rédaction-web-numev" />
                ...
                <div class="flex ">
                    <div class="w-[25%] hidden lg:block ">
                        ...
                        <img src="images/e604e49b-25bb-444d-8b3b-739b44b4b063.png"
                            alt="marketing-digital-service-création-de-site-web" class="lg:w-2/3 mt-4">
                    </div>
                    <div class="lg:w-[75%] mb-4 justify-center  mx-4 lg:mx-0 ">
                        <h2 class="ek vj text-xl lg:text-4xl kk wm nb gb ml-24 lg:ml-0">Formations & divers</h2>

                        <p class="text-sm lg:text-lg text-justify text-gray-600">Nos formations sont conçues pour vous
                            offrir une expérience d'apprentissage enrichissante et adaptée à vos besoins..</p>
                        <div class="lg:flex lg:mt-9 mt-4">


                            <img src="images/img.jpg" alt="marketing-digital-img-rédaction-web"
                                class="lg:w-[50%] h-64 ">


                            <p class="lg:ml-4 text-sm lg:text-lg mt-4 lg:mt-0 text-justify text-gray-600">
                                Que vous
                                souhaitiez acquérir de nouvelles compétences, approfondir vos connaissances ou vous
                                spécialiser dans un domaine spécifique, nos programmes de formation sont conçus par des
                                experts du secteur. Profitez d'un environnement d'apprentissage interactif et stimulant pour
